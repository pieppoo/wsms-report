...
{
    public partial class PurchaseSummaryReport : DevExpress.XtraReports.UI.XtraReport
    {
        public PurchaseSummaryData Data { get; set; }
            ...
            if (Data != null)
            {
                ...
                if (Data.PurchaseList != null && Data.PurchaseList.Count > 0)
                {
                    ...
                    foreach (var item in Data.PurchaseList)
                    {
                        ...
                        currRow.Cells[1].Text = item.PurchaseDate;
                        currRow.Cells[2].Text = item.SupplierName;
                        currRow.Cells[3].Text = item.PaymentType;
                        currRow.Cells[4].Text = item.SubTotal;
                        currRow.Cells[5].Text = item.Discount;
                        currRow.Cells[6].Text = item.Total;
                        currRow.Cells[7].Text = item.DueDate;
                        ...
                        if (!Data.PurchaseList.Last().Equals(item))
                        {
                            ...
                            currRow.Cells[5].TextAlignment = TextAlignment.MiddleCenter;

                            currRow.Cells[6].TextAlignment = TextAlignment.MiddleRight;
                            currRow.Cells[6].Padding = templateRow.Cells[6].Padding;

                            currRow.Cells[7].TextAlignment = TextAlignment.MiddleCenter;
                        }
                    }
                }
            }
