    ...
    public partial class CustomerReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public void PopulateData()
        {
            if (Data != null)
            {
                ...
                lblTotalItem.Text   = Data.CustomerList.Count.ToString();

                if (Data.CustomerList != null && Data.CustomerList.Count > 0)
                {
                    var i = 1;
                    ...
                    foreach (var item in Data.CustomerList)
                    {
                        ...
                        currRow.Cells[2].Text = item.Level;
                        currRow.Cells[3].Text = item.PhoneNo;
                        currRow.Cells[4].Text = item.Address;
                        currRow.Cells[5].Text = item.Debt;

                        if (!Data.CustomerList.Last().Equals(item))
                        {
